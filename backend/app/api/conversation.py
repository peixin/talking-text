...
Request: multipart/form-data
    ...
    session_id: uuid (must belong to the learner)
...
async def conversation_turn(
    ...
    # 2. Read upload + transcode webm -> ogg/opus.
    ...
    # 4. Touch session updated_at and generate title on first turn.
    await after_turn(
        session_id=session_id,
